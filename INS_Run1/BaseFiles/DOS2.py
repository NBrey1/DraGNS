...
def read_xvg(filename):
    ...
    # Compute the time step by averaging over all points
...
def main():
    ...
    groups = {
        'Ring N (N02, N05, N08)':    'vacf_ringN.xvg',
        'Ring C (C01, C03, C06)':    'vacf_ringC.xvg',
        'amine N (N00, N04, N07)':   'vacf_amineN.xvg',
        'amine H (H09-H0E)':        'vacf_amineH.xvg',
    }
    
    colors = {
        'Ring N (N02, N05, N08)':    'blue',
        'Ring C (C01, C03, C06)':    'gray',
        'amine N (N00, N04, N07)':   'green',
        'amine H (H09-H0E)':        'red',
    }
